...
import { useDeleteBookMutation } from '../../redux/features/books/bookSlice';
        ...
        <div class="book-card">
            ...
            <div class="flex-1 h-full pr-2 pt-2 flex flex-col">
                <div class="flex items-center justify-between">
                    <span class={`${featured && 'lws-badge'}`}>{featured && "Feature"}</span>
                    <div class="text-gray-500 space-x-2">
                        ...
                        <button onClick={del} class="lws-deleteBook">
                            <svg fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                <path stroke-linecap="round" stroke-linejoin="round"
